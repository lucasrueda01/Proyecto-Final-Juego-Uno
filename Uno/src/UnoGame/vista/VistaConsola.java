...
public class VistaConsola implements IVista {
	...
	public void iniciarJuego() throws Exception {
		...
		while (!terminado) {
			...
			if (jugadorActual.getMano().size() == 0) {
				...
				this.imprimirCartel(jugadorActual.getNombre() + " ha ganado con " + jugadorActual.getPuntaje()
						+ " puntos! Felicidades!!");
				terminado = true;
			}
		}
	...
	public Color elegirNuevoColor() {
		...
		switch (opcion) {
		case "1":
			nuevoColor = Color.ROJO;
			break;
		case "2":
			nuevoColor = Color.AMARILLO;
			break;
		case "3":
			nuevoColor = Color.AZUL;
			break;
		case "4":
